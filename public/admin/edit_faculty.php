...
<body>
    ...
    <?php include '../nav-sidebar-temp.php'?>
        ...
        <div class="container mt-4">
            ...
            <div class="form-container"> <!-- Added form-container class -->
                <form method="POST" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="firstname" name="firstname" value="<?php echo htmlspecialchars($faculty['firstname']); ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="lastname" class="form-label">Last Name</label>
                        <input type="text" id="lastname" name="lastname" value="<?php echo htmlspecialchars($faculty['lastname']); ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="gradeLevel" class="form-label">Grade Level</label>
                        <input type="text" id="gradeLevel" name="gradeLevel" value="<?php echo htmlspecialchars($faculty['gradeLevel']); ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="section" class="form-label">Section</label>
                        <input type="text" id="section" name="section" value="<?php echo htmlspecialchars($faculty['section']); ?>" required>
                    </div>
                    <div class="form-group">
